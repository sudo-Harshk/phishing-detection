            ...
            <main className="max-w-7xl mx-auto px-6 lg:px-8 pt-20 pb-24 md:pt-28 md:pb-32">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                    ...
                    <div className="flex-1 w-full max-w-lg lg:max-w-none">
                        <div className="relative aspect-[4/3] rounded-3xl bg-gradient-to-tr from-blue-50 via-indigo-50/80 to-violet-50 border border-slate-200/50 overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/40 via-transparent to-blue-100/30 rounded-3xl" />

                            <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-indigo-200/30 rounded-full blur-2xl animate-pulse" />
                            <div className="absolute bottom-1/4 right-1/4 w-24 h-24 bg-blue-200/40 rounded-full blur-2xl animate-pulse [animation-delay:1s]" />
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-violet-200/20 rounded-full blur-3xl animate-pulse [animation-delay:2s]" />
                            <div
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-center">
                                    <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/80 shadow-lg flex items-center justify-center">
